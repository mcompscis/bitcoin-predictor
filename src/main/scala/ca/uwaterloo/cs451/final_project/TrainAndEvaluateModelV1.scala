...
*/
class TrainAndEvaluateModelV1Conf(args: Seq[String]) extends ScallopConf(args) {
  mainOptions = Seq(blockpath)
  val blockpath = opt[String](descr = "block file", required = false)
  verify()
}

object TrainAndEvaluateModelV1 {
        
    def main(argv: Array[String]): Unit = {
        val args = new TrainAndEvaluateModelV1Conf(argv)
        ...
        val features = Array(
          "numUniqueReceivers", "numTxnsInBlock", "blockFeeReward", "totalBtcAmountReceivedInBlock", 
           ...
           "proportionOfReceiversWith75AccInBlock", "proportionOfReceiversWith80AccInBlock",
            "proportionOfReceiversWith90AccInBlock", "currBitcoinPrice", "bitcoinPrice1HrAgo",
           "bitcoinPrice2HrAgo", "bitcoinPrice3HrAgo", "bitcoinPrice4HrAgo", 
           "avgAmtOfBtcPerTxn", "numTxnsWithMoreThan10Outputs", "numHighValueTxnsInBlock"
          )
